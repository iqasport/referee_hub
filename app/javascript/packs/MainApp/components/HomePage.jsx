  ...
  render() {
    return (
      <Segment textAlign='center'>
        ...
        <p>
          If you're not a referee you do not have to register, but you can search for and view referees based on ther certifications, what National Governing Body they are affiliated with, and their name.
        </p>
        <Divider />
