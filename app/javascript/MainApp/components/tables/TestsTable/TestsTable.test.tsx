...
describe('TestsTable', () => {
  ...
  it('renders the expected text rows', () => {
    ...
    screen.getAllByText(formatLanguage(languages.find(lang => lang.id === tests[0].attributes.newLanguageId.toString())))
    screen.getAllByText(
      toDateTime(tests[0].attributes.updatedAt).toFormat("D")
    );
  });
