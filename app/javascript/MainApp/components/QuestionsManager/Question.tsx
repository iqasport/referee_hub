...
const Question = (props: QuestionProps) => {
  ...
  const renderDescription = () => {
    return (
      <div
        dangerouslySetInnerHTML={{ __html: question.attributes.description }}
      />
    );
  }
  ...
  return (
    <>
      <div className="flex items-start w-full my-4">
        ...
        <div className="ml-4">
          <button type="button" className="bg-red-600 text-white rounded h-8 w-8" onClick={handleDeleteClick}>
