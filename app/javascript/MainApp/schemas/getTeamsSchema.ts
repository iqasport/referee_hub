...
const typeMap: any = {
    ...
    "Relationships": o([
        { json: "nationalGoverningBody", js: "nationalGoverningBody", typ: r("NationalGoverningBody") },
    ], false),
    "NationalGoverningBody": o([
    ...
    "Name": [
        "Virginia Academy of Administration Quidditch Club",
    ],
    "Status": [
        "competitive",
    ],
