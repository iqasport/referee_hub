...
ActiveRecord::Schema.define(version: 20_180_901_201_402) do
  ...
  create_table 'referee_locations', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[referee_id national_governing_body_id], name: 'index_referee_locations_on_referee_id_and_ngb_id', unique: true
  end
