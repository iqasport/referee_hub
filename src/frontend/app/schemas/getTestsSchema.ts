// To parse this data:
//
//   import { Convert, GetTestsSchema } from "./file";
//
//   const GetTestsSchema = Convert.toGetTestsSchema(json);
//
...
export class Convert {
  public static toGetTestsSchema(json: string): GetTestsSchema {
    return cast(JSON.parse(json), r("GetTestsSchema"));
  }

  public static getTestsSchemaToJson(value: GetTestsSchema): string {
    return JSON.stringify(uncast(value, r("GetTestsSchema")), null, 2);
  }
}
...
const typeMap: any = {
  GetTestsSchema: o([{ json: "data", js: "data", typ: a(r("Datum")) }], false),
  Datum: o(
    [
      { json: "id", js: "id", typ: "" },
