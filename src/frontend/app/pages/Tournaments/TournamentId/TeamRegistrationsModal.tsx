...
import { isTeamInvite } from "./inviteUtils";

export interface TeamRegistrationsModalRef {
  open: (tournamentId: string, tournamentName: string) => void;
}

const TeamRegistrationsModal = forwardRef<TeamRegistrationsModalRef>((_props, ref) => {
  ...
  const selectedInviteData = teamInvites.find((i) => i.participantId === selectedInvite);
            ...
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <DialogTitle as="h3" className="text-xl font-semibold text-gray-900">
                  {selectedInvite ? "Team Registration Details" : "Team Registrations"}
                </DialogTitle>
                <button
                  onClick={close}
...
TeamRegistrationsModal.displayName = "TeamRegistrationsModal";
