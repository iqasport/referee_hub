...
const stepTemplateMap: { [scope: string]: string } = {
  ngb:
    "https://docs.google.com/spreadsheets/d/1Z5Wf-2CMYrXvk87gaglNRwZkO6tLuTolz6InhyJhpAQ/edit?usp=sharing",
  team:
    "https://docs.google.com/spreadsheets/d/17NOk3OjKls8y2gih5PTz5Avw7wJ0mY_x3Cl-hkFOcrA/edit?usp=sharing",
  test:
    "https://docs.google.com/spreadsheets/d/1TIGX1CpuSyaGJBwaZzVB1eb7zhw9BvjoWezgUaXbRKU/edit?usp=sharing",
};
    ...
    <div className="relative my-12 mx-auto">
      ...
      <div className="flex w-full z-1">
        <div className={classnames("step-container", { ["step-active"]: isStepActive(1) })}>
          <h3 className={classnames("step-number", { ["step-active"]: isStepActive(1) })}>
            Step 1
          </h3>
