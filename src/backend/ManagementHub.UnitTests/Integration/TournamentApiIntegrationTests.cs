...
public class TournamentApiIntegrationTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async Task Tournament_FullWorkflow_ShouldSucceed()
    {
        ...
        var createModel = new TournamentModel
        {
            ...
            TournamentType = TournamentType.Club,
            Location = "Test City",
        ...
        listedTournament.TournamentType.Should().Be(TournamentType.Club);
        listedTournament.Location.Should().Be("Test City");
        ...
        updatedTournament.TournamentType.Should().Be(TournamentType.National, 
            "tournament type should be updated");
        updatedTournament.Location.Should().Be("Updated City", 
            "tournament location should be updated");
        updatedTournament.Organizers.Should().Be("Updated Organizers", 
            "tournament organizers should be updated");
