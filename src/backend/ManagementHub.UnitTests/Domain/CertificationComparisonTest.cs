...
public class CertificationComparisonTest
{
	private readonly List<Certification> certifications = new List<Certification>()
	{
		...
		new Certification(CertificationLevel.FlagRunner, CertificationVersion.Twenty),
		...
		new Certification(CertificationLevel.FlagRunner, CertificationVersion.Eighteen),
