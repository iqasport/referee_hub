...
public partial class AddTournamentInvitesAndParticipants : Migration
{
	...
	{
		migrationBuilder.DropTable(name: "team_managers");
		migrationBuilder.DropTable(name: "tournament_invites");
		migrationBuilder.DropTable(name: "tournament_team_participants");
	}
}
